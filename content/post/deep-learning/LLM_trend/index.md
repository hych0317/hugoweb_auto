...
### 几种身份的区别
**目标和动机的差异**
![差别](post/deep-learning/LLM_trend/diff.png)
大厂的目标是升职加薪，PhD的目标就是博士毕业，创业的目标就是套现退出

**优缺点分析**
![打工人](post/deep-learning/LLM_trend/dgr.png)
晚上不用做噩梦，但逐渐成为螺丝钉。  
好处是，可以在一个相对简单的环境里学习各种从业知识、有相对稳定的收入和空余时间；坏处就是停留在打工人或者职业经理人的思维。

![PhD](post/deep-learning/LLM_trend/phd.png)
...
![创业](post/deep-learning/LLM_trend/startup.png)

### 驱动力的来源
![动机](post/deep-learning/LLM_trend/motivation.png)
